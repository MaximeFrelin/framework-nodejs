...
AbstractTable.prototype.setColumnsNamesFromDB = function(callback){
    console.log("SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'"+this.tableName+"' AND TABLE_SCHEMA = '"+this.connexion.config.database+"'");
...
AbstractTable.prototype.insert = function(c,v){
